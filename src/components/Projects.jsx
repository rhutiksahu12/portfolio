    ...
    <section className="space-y-4">
      ...
      <div className="bg-[#1a1b26] border border-[#414868] p-4 rounded-md space-y-6">
        <div>
          ...
          <p className="ml-4 text-[#c0caf5] break-words">
            git clone <span className="text-[#7aa2f7] break-all">https://github.com/rhutiksahu12/hireFrontTrae</span>
          </p>
        ...
        <div>
          <p className="text-[#9ece6a]">$</p>
          <p className="ml-4 text-[#c0caf5] break-words">
            git clone <span className="text-[#7aa2f7] break-all">https://github.com/rhutiksahu12/portfolio</span>
          </p>
          <p className="ml-4 text-[#c0caf5]">
